...
# Automatically load the patient data (replace with the correct path)
patient_data_path = "import streamlit as st
import pandas as pd
import numpy as np
import shap
import tensorflow as tf
...
# Automatically load the patient data (replace with the correct path)
patient_data_path = "WAVE_1L5K_with_binary_periodontitis.xlsx"  # Set your local file path here
...
.xlsx"  # Set your local file path here
df = pd.read_excel(patient_data_path)
